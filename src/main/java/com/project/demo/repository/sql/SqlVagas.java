...
public class SqlVagas {
    ...
    @Getter
    private static String sql_searchJobs = "SELECT TITULO, DESCRICAO, VALOR_MENSAL, DATA_PUBLICACAO, LOCAL_ATUACAO FROM ALISSON.VAGAS WHERE TITULO LIKE UPPER('%' || :DESCRICAO || '%') OR :DESCRICAO LIKE UPPER('%' || :DESCRICAO || '%')";
}
